    ...
    for (const pool of data.poolBreakdown) {
      ...
      for (const position of [...pool.openPositions, ...pool.closedPositions]) {
        ...
        upsertWalletPosition({
          ...
          pnl_1d_usd: position.pnl1dUsd,
          pnl_1d_sol: position.pnl1dSol,
          fees_1d_usd: position.fees1dUsd,
          pnl_7d_usd: position.pnl7dUsd,
          pnl_7d_sol: position.pnl7dSol,
          fees_7d_usd: position.fees7dUsd,
